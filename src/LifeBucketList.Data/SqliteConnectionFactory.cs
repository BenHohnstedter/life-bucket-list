...
public sealed class SqliteConnectionFactory
{
    ...
    public async Task InitializeAsync()
    {
        ...
        var categoryCount = (long)(await countCommand.ExecuteScalarAsync())!;
    ...
    private static async Task SeedDefaultCategoriesAsync(SqliteConnection connection)
    {
        ...
        for (var i = 0; i < DefaultCategories.Names.Count; i++)
        {
            ...
            insert.Parameters.AddWithValue("$name", DefaultCategories.Names[i]);
